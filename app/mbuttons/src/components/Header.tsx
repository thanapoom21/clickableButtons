...
function Header({ activePage = null, showMenuButton = false }: { activePage: string | null, showMenuButton: boolean }) {
    ...
    return (
        <nav className="shadow-sm py-5 dark:bg-gray-600 bg-white dark:text-white transition-colors duration-100">
            <div className="container flex flex-row mx-auto">
                ...
                <Link href="/" className={`lg:w-2/12 ${showMenuButton ? 'w-4/12' : 'w-4/12'}`}>
                ...
                <div className="md:flex hidden items-center lg:w-6/12">
                    ...
                    <Link href="/projects-using-sbuttons"
                ...
                <div className="justify-end flex items-center lg:w-4/12 md:w-2/12 w-4/12 md:mx-0 mr-0 ml-auto">
                    ...
                    <button className="block group md:hidden px-3 relative focus:outline-none align-text-bottom">
                        ...
                        <div className="absolute bg-gray-100 w-52 dark:bg-gray-700 group-hover:block group-focus:block hidden right-1.5 shadow-md top-9">
                            <Link className="block dark:hover:bg-gray-800 dark:hover:text-white dark:text-gray-100 hover:bg-gray-200 hover:text-gray-600 px-4 py-2 text-gray-500 text-lg text-left" href="/documentation">
                                Get Started
                            </Link>
                            <Link className="block dark:hover:bg-gray-800 dark:hover:text-white dark:text-gray-100 hover:bg-gray-200 hover:text-gray-600 px-4 py-2 text-gray-500 text-lg text-left" href="/examples">
                                Examples
                            </Link>
                            <Link className="block dark:hover:bg-gray-800 dark:hover:text-white dark:text-gray-100 hover:bg-gray-200 hover:text-gray-600 px-4 py-2 text-gray-500 text-md text-left" href="/projects-using-sbuttons">
                                Projects Using sButtons
                            </Link>
                        </div>
                    </button>
